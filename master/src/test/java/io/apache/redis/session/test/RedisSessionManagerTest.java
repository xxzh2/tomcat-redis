...
import io.apache.redis.session.DeserializedSessionContainer;
import io.apache.redis.session.JavaSerializer;
import io.apache.redis.session.RedisSession;
import io.apache.redis.session.RedisSessionHandlerValve;
import io.apache.redis.session.RedisSessionManager;
import io.apache.redis.session.Serializer;
import io.apache.redis.session.SessionSerializationMetadata;
...
public class RedisSessionManagerTest extends ManagerBase implements Lifecycle {
